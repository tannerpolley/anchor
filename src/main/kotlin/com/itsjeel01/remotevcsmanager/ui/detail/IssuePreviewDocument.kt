...
data class IssuePreviewTheme(
    ...
    companion object {
        fun fromIde(): IssuePreviewTheme =
            IssuePreviewTheme(
                background = ColorUtil.toHtmlColor(JBColor.PanelBackground),
                foreground = ColorUtil.toHtmlColor(JBColor.foreground()),
                border = ColorUtil.toHtmlColor(JBColor.border()),
                secondary = ColorUtil.toHtmlColor(blend(JBColor.foreground(), JBColor.PanelBackground, 0.58f)),
                muted = ColorUtil.toHtmlColor(blend(JBColor.foreground(), JBColor.PanelBackground, 0.38f)),
                link = ColorUtil.toHtmlColor(JBUI.CurrentTheme.Link.Foreground.ENABLED),
                codeBackground = if (JBColor.isBright()) "#F6F8FA" else "#20242B",
                itemBackground = if (JBColor.isBright()) "#FFFFFF" else "#1B1D22"
            )
    }
}

object IssuePreviewDocument {

    fun buildPlaceholder(message: String, theme: IssuePreviewTheme = IssuePreviewTheme.fromIde()): String =
        buildThemedPage(
            """
    ...
    fun buildLoading(issue: Issue, theme: IssuePreviewTheme = IssuePreviewTheme.fromIde()): String =
        buildThemedPage(
            """
    ...
    fun buildIssue(
        ...
        theme: IssuePreviewTheme = IssuePreviewTheme.fromIde()
    ): String {
    ...
    private fun buildThemedPage(body: String, theme: IssuePreviewTheme): String =
        """
            <!doctype html>
            <html>
            <head>
